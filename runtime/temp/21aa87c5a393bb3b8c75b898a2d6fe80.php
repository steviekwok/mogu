<?php /*a:2:{s:64:"/usr/local/nginx/html/shop/application/admin/view/image/add.html";i:1567169044;s:66:"/usr/local/nginx/html/shop/application/admin/view/public/base.html";i:1556897292;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <div id="uploader-demo">
            ...
            <span id="tip" style="position:absolute; margin-left: 280px; margin-top: -50px;"></span>
          </div>
        </div>
      </div>
      <div class="form-group">
...
<script>
    ...
    uploader.on( 'uploadSuccess', function( file, data ) {
        if(data.status == 'success') {
            $('#tip').html('<img style="width: 200px; height: 80px;" src=/'+data.msg+'>');
