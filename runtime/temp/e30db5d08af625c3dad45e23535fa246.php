<?php /*a:2:{s:65:"/usr/local/nginx/html/shop/application/admin/view/goods/edit.html";i:1560362183;s:66:"/usr/local/nginx/html/shop/application/admin/view/public/base.html";i:1556897292;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/admin/goods/<?php echo htmlentities($goods['goods_id']); ?>">
        <input type="hidden" name="_method" value="put">
        <input type="hidden" name="goods_id" value="<?php echo htmlentities($goods['goods_id']); ?>" />
        <div class="form-group">
        <div class="label">
          <label>商品名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="<?php echo htmlentities($goods['goods_name']); ?>" name="goods_name" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
            <select name="cat_id" class="input w50">
                ...
                <option value="<?php echo htmlentities($vo['cat_id']); ?>" <?php echo $goods['cat_id']==$vo['cat_id'] ? 'selected' : ''; ?>><?php echo htmlentities($vo['cat_name']); ?></option>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo htmlentities($goods['original_price']); ?>" name="original_price" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo htmlentities($goods['pro_price']); ?>" name="pro_price" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
            ...
            <div class="field">
                <div id="uploader-dem1o">
                    ...
                    <span id="tip1" style="position:absolute; margin-left: 240px; margin-top: -300px;">
                        <img style="width: 240px; height: 300px;" src=/<?php echo htmlentities($goods['goods_img']); ?>>
                        <input type="hidden" name="goods_img" value=<?php echo htmlentities($goods['goods_img']); ?>>
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="field">
                <div id="uploader-demo2">
                    ...
                    <span id="tip2" style="position:absolute; margin-left: 100px; margin-top: -50px;">
                        ...
                        <img style="width: 60px; height: 76px;" src=/<?php echo htmlentities($vo); ?>>
                        <input type="hidden" name="goods_color[]" value=<?php echo htmlentities($vo); ?>>
                        <input type="text" name="goods_color_desc[]" size="15" value=<?php echo htmlentities($goods['goods_color_desc'][$key]); ?>>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </span>
                </div>
            </div>
      ...
      <div class="form-group">
        ...
        <div class="field" style="padding-top:8px;">
          是 <input name="is_on" value="1" type="radio" <?php echo !empty($goods['is_on']) ? 'checked' : ''; ?>/>
          否 <input name="is_on" value="0" type="radio" <?php echo !empty($goods['is_on']) ? '' : 'checked'; ?>/>
        </div>
      </div>
        ...
        <div class="form-group">
            ...
            <div class="field" style="padding-top:8px;">
                是 <input name="is_hot" value="1" type="radio" <?php echo !empty($goods['is_hot']) ? 'checked' : ''; ?>/>
                否 <input name="is_hot" value="0" type="radio" <?php echo !empty($goods['is_hot']) ? '' : 'checked'; ?>/>
            </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo htmlentities($goods['goods_type']); ?>" name="goods_type" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
            ...
            <div class="field">
                <div id="uploader-demo3">
                    ...
                    <span id="tip3" style="position:absolute; margin-left: 650px; margin-top: -500px;">
                        <img style="width: 300px; height: 500px;" src=/<?php echo htmlentities($goods['goods_desc']); ?>>
                        <input type="hidden" name="goods_desc" value=<?php echo htmlentities($goods['goods_desc']); ?>>
                    </span>
                </div>
            </div>
        </div>
